...
let budgetController = (function () {
    ...
    return {
        ...
        addItem: function (type, des, val) { // inc, taxes, 700 for example
            let newItem, ID;
...
let UIController = (function () {
    ...
    let DOMstrings = { // contains class names for querySelector below
        inputType: '.add__type',
    ...
    return {
        ...
        clearFields: function () {
            ...
            fieldsArr = Array.prototype.slice.call(fields); // fieldsArr is not an array, it's a nodeList. Because of that we can't use arrays method directly, but we can with proto property
...
let controller = (function (budgetCrtl, UICtrl) {
    ...
    let updateBudget = function () {
        ...
        // 2. Return the budget
        let budget = budgetCrtl.getBudget();
    ...
    let updatePercentages = function () {
        ...
        let percentages = budgetCrtl.getPercentages();
